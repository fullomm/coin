...
describe('Integration Test', () => {
    ...
    const createbitcoinnexx  = (name, host, port, peers, removeData = true) => {
    ...
    step('start server 1', () => {
        return createbitcoinnexx (name1, 'localhost', 3001, [])
            .then((httpServer) => {
    ...
    step('start server 2', () => {
        return createbitcoinnexx (name2, 'localhost', 3002, [{ url: 'http://localhost:3001' }])
            .then((httpServer) => {
    ...
    describe('Complementary tests', () => {
        ...
        step('restart server 1', () => {
            return Promise.resolve()
                ...
                .then(() => {
                    return createbitcoinnexx (name1, 'localhost', 3001, [], false)
                        .then((httpServer) => {
                            context.httpServer1 = httpServer;
                        });
                });
